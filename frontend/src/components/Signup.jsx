...
const  Signup = () =>  {
  ...
  return (
    <div className =" min-w-96 mx-auto">
      <div className = 'w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border border-gray-100'>
          ...
          <form onSubmit = {onSubmitHandler} action="">
            ...
            <div>
              ...
              <button type = 'submit' className="w-full h-10 btn btn-success btn-sm mt-2 border border-slate-700">
                Signup
              </button>
            </div>
